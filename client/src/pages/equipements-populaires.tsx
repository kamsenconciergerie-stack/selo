...
export default function EquipementsPopulaires() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
                  ...
                  <div className="border-t pt-4 space-y-3">
                    ...
                    <div className="flex gap-2">
                      <Link href={`/equipements/${item.id}`} className="flex-1">
                        <Button className="w-full bg-aywa-blue hover:bg-aywa-blue/90">
                          Voir détails
                        </Button>
                      </Link>
      ...
      {/* Call to Action */}
      <section className="py-16 bg-aywa-blue text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/equipements">
              <Button size="lg" variant="secondary" className="bg-white text-aywa-blue hover:bg-gray-100">
                Voir tous les équipements
              </Button>
            </Link>
            <Link href="/contact">
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-aywa-blue">
                Demander un devis
              </Button>
            </Link>
          </div>
