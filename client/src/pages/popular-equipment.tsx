        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              <TrendingUp className="h-12 w-12 text-primary-orange mr-4" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center text-white">
            <div>
              ...
              <p className="text-gray-300">Générateurs électriques</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-primary-orange mb-2">28%</div>
              <p className="text-gray-300">Engins de construction</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-primary-orange mb-2">20%</div>
              <p className="text-gray-300">Équipements agricoles</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-primary-orange mb-2">17%</div>
              <p className="text-gray-300">Matériel hydraulique</p>
            </div>
          </div>
        </div>
      </section>
