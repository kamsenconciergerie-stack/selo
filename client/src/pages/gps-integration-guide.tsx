            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <Badge variant="secondary" className="bg-green-100 text-green-800 block w-fit">
                      ✓ Aucun coût matériel
                    </Badge>
                    <Badge variant="secondary" className="bg-green-100 text-green-800 block w-fit">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">Position précise en temps réel</p>
                </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">Marche/arrêt, heures d'utilisation</p>
                </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">Suivi consommation</p>
                </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">Alertes vol, zone interdite</p>
                </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">Diagnostics préventifs</p>
                </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">Statistiques d'usage détaillées</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent>
                <div className="space-y-6">
                  <div className="border-l-4 border-l-blue-500 pl-4">
                    ...
                    <p className="text-sm text-gray-600 mt-1">Application mobile chauffeur</p>
                  ...
                  <div className="border-l-4 border-l-orange-500 pl-4">
                    ...
                    <p className="text-sm text-gray-600 mt-1">Trackers GPS sur gros équipements</p>
                    <ul className="text-sm text-gray-600 mt-2 space-y-1">
                  ...
                  <div className="border-l-4 border-l-green-500 pl-4">
                    ...
                    <p className="text-sm text-gray-600 mt-1">IoT avancé sur toute la flotte</p>
                    <ul className="text-sm text-gray-600 mt-2 space-y-1">
