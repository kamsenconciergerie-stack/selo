  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-kamsen-gray">Total Suivi</p>
                <p className="text-2xl font-bold text-kamsen-blue">{trackingData.length}</p>
              </div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-kamsen-gray">En Transit</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-kamsen-gray">Livrés</p>
                <p className="text-2xl font-bold text-kamsen-blue">{getDeliveredTrackings().length}</p>
              </div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2 text-sm">
                            <MapPin className="h-4 w-4 text-kamsen-gray" />
                            <span className="font-medium">{tracking.city}</span>
                            {tracking.address && (
                              <span className="text-kamsen-gray">- {tracking.address}</span>
                            )}
                          </div>
                            ...
                            <div className="flex items-center gap-2 text-sm">
                              ...
                              {tracking.driverPhone && (
                                <a 
                                  ...
                                  className="text-kamsen-blue hover:underline flex items-center gap-1"
                                >
                          ...
                          {tracking.estimatedArrival && (
                            <div className="flex items-center gap-2 text-sm">
                              ...
                              <span className="text-kamsen-gray">
      ...
      {trackingData.length === 0 && (
        <div className="text-center py-12 text-kamsen-gray">
